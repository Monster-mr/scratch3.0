...
if __name__ == "__main__":
  try:
    closure_dir = CLOSURE_DIR_NPM      # "node_modules"
    closure_root = CLOSURE_ROOT_NPM       # os.path.join("node_modules")
    closure_library = CLOSURE_LIBRARY_NPM   # "google-closure-library"
    closure_compiler = CLOSURE_COMPILER_NPM  # "google-closure-compiler"

    # Load calcdeps from the local library
    calcdeps = import_path(os.path.join(
        closure_root, closure_library, "closure", "bin", "calcdeps.py"))        #calcdeps node modulesclosure library return modules

    # Sanity check the local compiler
    test_args = [closure_compiler, os.path.join("build", "test_input.js")]     # test args
